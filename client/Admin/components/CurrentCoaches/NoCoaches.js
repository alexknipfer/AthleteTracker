...
export default class NoCoaches extends React.Component{
  render(){
          ...
          <div className="col s12 m8 l6 offset-l3 offset-m2">
            <div className="card red lighten-3">
              <div className="card-content white-text no-coaches-card">
                ...
                <p>
                  Welcome to the Lindenwood University athelete / student tracking
                  system.
                </p>
                ...
                <p>
                  You currently have no coaches enrolled in the tracking system.
